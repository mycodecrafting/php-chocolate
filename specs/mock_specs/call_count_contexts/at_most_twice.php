<?php
/* $Id: at_most_twice.php 62 2007-03-20 12:52:17Z dreamscape $ */
/**
 * @package PackageName
...
class call_count_at_most_twice extends a_context
{
	...
	public function setup()
	{
		...
		$this->mock->should_receive->a_call()->at_most->twice;
	}
	...
	public function should_fail_when_method_is_called_three_times()
	{
		$this->mock->a_call();
		$this->mock->a_call();
		$this->mock->a_call();
