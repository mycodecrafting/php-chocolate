<?php
/* $Id: at_least_n.php 62 2007-03-20 12:52:17Z dreamscape $ */
/**
 * @package PackageName
...
class call_count_at_least_n extends a_context
{
	...
	public function setup()
	{
		...
		$this->mock->should_receive->a_call()->at_least($this->n)->times;
	}
	...
	public function should_fail_when_method_is_called_less_than_n_times()
	{
	...
	public function should_pass_when_method_is_called_more_than_n_times()
	{
		for ($i=0; $i<($this->n + 1); ++$i)
		{
			$this->mock->a_call();
