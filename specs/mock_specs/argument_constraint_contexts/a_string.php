<?php
/* $Id: a_string.php 62 2007-03-20 12:52:17Z dreamscape $ */
/**
 * @package PackageName
...
class a_string_argument_constraint extends a_context
{
	...
	public function setup()
	{
		...
		$this->mock->should_receive('a_call')->with(a_string);
