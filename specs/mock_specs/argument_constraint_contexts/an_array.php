<?php
/* $Id: an_array.php 62 2007-03-20 12:52:17Z dreamscape $ */
/**
 * @package PackageName
...
class an_array_argument_constraint extends a_context
{
	...
	public function setup()
	{
		...
		$this->mock->should_receive('a_call')->with(an_array);
