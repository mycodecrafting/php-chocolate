<?php
/* $Id: should_not_be_null.php 66 2007-10-28 19:50:20Z dreamscape $ */
/**
 * @package PackageName
...
class value_should_not_be_null extends a_context
{
	...
	public function should_provide_message_on_failure()
	{
		...
		$value->should_not_be->null;
		$this->value($value->do_comparison())->should_be->exactly(
			'Did not expect type null'
		);
	}
