<?php
/* $Id: should_be_greater_than_or_equal_to.php 66 2007-10-28 19:50:20Z dreamscape $ */
/**
 * @package PackageName
...
class value_should_be_greater_than_or_equal_to extends a_context
{
	...
	public function should_provide_message_on_failure()
	{
		...
		$value->should_be->greater_than->or_equal_to(2.1);
		$this->value($value->do_comparison())->should_be->exactly(
			'Expected <2.01> to be greater than or equal to <2.1>'
		);
	}
