<?php
/* $Id: should_be_less_than.php 66 2007-10-28 19:50:20Z dreamscape $ */
/**
 * @package PackageName
...
class value_should_be_less_than extends a_context
{
	...
	public function should_provide_message_on_failure()
	{
		...
		$value->should_be->less_than(2.01);
		$this->value($value->do_comparison())->should_be->exactly(
			'Expected <2.1> to be less than <2.01>'
		);
	}
