<?php
/* $Id: should_be_a_float.php 66 2007-10-28 19:50:20Z dreamscape $ */
/**
 * @package PackageName
...
class value_should_be_a_float extends a_context
{

	public function should_pass_when_actual_is_a_float()
	{
		$this->value(1.5)->should_be->a_float;
	}

	public function should_fail_when_actual_is_a_string()
	{
		$this->value('1.5')->should_be->a_float->should_fail;
	}

	public function should_fail_when_actual_is_an_array()
	{
		$this->value(array(1.5))->should_be->a_float->should_fail;
	}

	public function should_fail_when_actual_is_an_integer()
	{
		$this->value(1)->should_be->a_float->should_fail;
	}

	public function should_fail_when_actual_is_an_object()
	{
		$this->value(new stdClass)->should_be->a_float->should_fail;
	}

	public function should_fail_when_actual_is_null()
	{
		$this->value(null)->should_be->a_float->should_fail;
	}

	public function should_fail_when_actual_is_true()
	{
		$this->value(true)->should_be->a_float->should_fail;
	}

	public function should_fail_when_actual_is_false()
	{
		$this->value(false)->should_be->a_float->should_fail;
	}
