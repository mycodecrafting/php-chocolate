<?php
/* $Id: should_not_be_instance_of.php 64 2007-10-28 19:29:17Z dreamscape $ */
/**
 * @package PackageName
...
class object_should_not_be_instance_of extends a_context
{

	public function should_pass_unless_actual_is_an_instance_of_expected()
	{
		$this->object(new php_chocolate)->should_not_be->instance_of('stdClass');
	}

	public function should_fail_when_actual_is_an_instance_of_expected()
	{
		$this->object(new stdClass)->should_not_be->instance_of('stdClass')->should_fail;
	}
	...
	public function should_provide_message_on_failure()
	{
		...
		$object->should_not_be->instance_of('stdClass');
