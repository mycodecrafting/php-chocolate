<?php
/* $Id: object_generator.php 63 2007-03-26 00:03:34Z dreamscape $ */
...
class mocked_object_generator extends mocked_generator
{

    protected $prefix = 'mock';
    protected $handler = 'mocked_object_handler';
