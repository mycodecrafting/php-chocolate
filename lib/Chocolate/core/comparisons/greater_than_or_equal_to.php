<?php
/* $Id: greater_than_or_equal_to.php 64 2007-10-28 19:29:17Z dreamscape $ */
...
class greater_than_or_equal_to_comparison implements a_comparison
{
    ...
    {
        return "Did not expect <{$actual}> to be greater than or equal to <{$expected}>";
    }
